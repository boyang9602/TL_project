...
command_prefix = f'python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3'
...
'''
for cls_loss in cls_loss_list:
    sh += make_command(command_prefix + f' -c {cls_loss}')

output = args.output
if output is None:
    output = f'code/scripts/nontargetattack.sh'
