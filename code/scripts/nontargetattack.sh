...
echo python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss
python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss
...
echo python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss -t cls_nll_loss
python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss -t cls_nll_loss
...
echo python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -rb box_iou_loss
python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -rb box_iou_loss
...
echo python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -rb box_iou_loss -o cls_nll_loss
python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -rb box_iou_loss -o cls_nll_loss
...
echo python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss -rb box_iou_loss
python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss -rb box_iou_loss
...
echo python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss -t cls_nll_loss -rb box_iou_loss -o cls_nll_loss
python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss -t cls_nll_loss -rb box_iou_loss -o cls_nll_loss
...
echo python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss -c cls_nll_loss
python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss -c cls_nll_loss
...
echo python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss -t cls_nll_loss -c cls_nll_loss
python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss -t cls_nll_loss -c cls_nll_loss
...
echo python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -rb box_iou_loss -c cls_nll_loss
python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -rb box_iou_loss -c cls_nll_loss
...
echo python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -rb box_iou_loss -o cls_nll_loss -c cls_nll_loss
python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -rb box_iou_loss -o cls_nll_loss -c cls_nll_loss
...
echo python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss -rb box_iou_loss -c cls_nll_loss
python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss -rb box_iou_loss -c cls_nll_loss
...
echo python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss -t cls_nll_loss -rb box_iou_loss -o cls_nll_loss -c cls_nll_loss
python code/attack/nontarget_experiment.py -ds $1 -e $2 -m $3 -b box_iou_loss -t cls_nll_loss -rb box_iou_loss -o cls_nll_loss -c cls_nll_loss
